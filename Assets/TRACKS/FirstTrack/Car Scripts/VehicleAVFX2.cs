...
public class VehicleAVFX2 : MonoBehaviour
{
    ...
    PlayerInput2 input;                      //A reference to the player's input
    VehicleMovement2 movement;               //A reference to the ship's VehicleMovement script
    ...
    void Start()
    {
        ...
        input = GetComponent<PlayerInput2>();
        movement = GetComponent<VehicleMovement2>();
